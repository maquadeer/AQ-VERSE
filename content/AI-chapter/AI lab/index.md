...
d={"usa":100,"uk":[200,"Quadeer"],"india":(300,"ash")}
print(d)
...
#sets
set={'Quadeer','ash','python','science'}
print(set)

set={'Quadeer','ash','python','science','ash'}
print(set)
...
tree = Tree()
tree.create_node('Quadeer','Quadeer')#root node
tree.create_node('jane','Jane',parent='Quadeer')
tree.show()
...
from treelib import Tree
tree=Tree()
tree.create_node(1,'Quadeer')
tree.create_node(2,2,parent='Quadeer')
tree.create_node(3,3,parent='Quadeer')
